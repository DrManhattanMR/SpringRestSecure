...
Configure your DB Conecction propierties in application.propierties 
...
* http://localhost:8080/api/auth/register  
  Envía un json en el body para agregar un usuario
  ```json
  {
    "username": "juan",
    "password": "123456",
...
Envía un json en el body para iniciar sesión  
```json
  {
    "username": "juan",
    "password": "12345"
